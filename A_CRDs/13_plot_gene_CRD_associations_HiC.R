...
path2='/Users/dianaavalos/Programming/A_CRD_plots/quantify_ALL'
...
name_cond <- c('hist_70', 'hist_72','hist_73')
names(name_cond) <- c("neut", "mono", "tcell")
...
name_condition=name_cond[["neut"]]
corr_genes=fread(paste0(path,rna_file[["neut"]]))
